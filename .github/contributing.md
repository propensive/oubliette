...
Firstly, thank you for taking an interesting in contributing! Oubliette is an
...
Oubliette is one of a large number of
...
issue](https://github.com/propensive/oubliette/issues) or contact the project
...
have commit rights to the `propensive/oubliette` repository, push to a branch named
...
in extreme cases. Oubliette does not use automatic code-formatting because it
...
Oubliette&rsquo;s users. Individualism is valued, and nobody should feel
